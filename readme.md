...
- [DEMO LINK](https://<YuriySobakar>.github.io/layout_search-bar-airbnb/)
- [TEST REPORT LINK](https://<YuriySobakar>.github.io/layout_search-bar-airbnb/report/html_report/)
