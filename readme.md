...
- [DEMO LINK](https://<monikaprochniewicz>.github.io/layout_search-bar-airbnb/)
- [TEST REPORT LINK](https://<monikaprochniewicz>.github.io/layout_search-bar-airbnb/report/html_report/)
