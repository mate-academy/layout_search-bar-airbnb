...
- [DEMO LINK](https://batiukova-nataliia.github.io/layout_search-bar-airbnb/)
- [TEST REPORT LINK](https://batiukova-nataliia.github.io/layout_search-bar-airbnb/report/html_report/)
...
## The task
> Create HTML page with two search bars as designed in [the mockup](https://ww w.figma.com/file/kf3AWulK9elrNk34wtpjPw/Airbnb-Search-bar?node-id=0%3A1). This search bar will be part of big project.
