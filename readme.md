...
1. Replace `<your_account>` with your Github username in the links
    - [DEMO LINK](https://yevhenii-kozak.github.io/layout_search-bar-airbnb/)
    - [TEST REPORT LINK](https://yevhenii-kozak.github.io/layout_search-bar-airbnb/report/html_report/)
