...
❗️ Replace `Velkovd7` with your Github username and copy the links to `Pull Request` description:

- [DEMO LINK](https://Velkovd7.github.io/layout_search-bar-airbnb/)
- [TEST REPORT LINK](https://Velkovd7.github.io/layout_search-bar-airbnb/report/html_report/)
