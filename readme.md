...
- [DEMO LINK](https://Mikitkaaist.github.io/layout_search-bar-airbnb/)
- [TEST REPORT LINK](https://Mikitkaaist.github.io/layout_search-bar-airbnb/report/html_report/)
...
![screenshot](./referencesz/search-bar-example.png)
