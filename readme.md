...
- [DEMO LINK](https://Yuliia-Kyrygit commit -m 'commit message'chenko.github.io/layout_search-bar-airbnb/)
- [TEST REPORT LINK](https://Yuliia-Kyrychenko.github.io/layout_search-bar-airbnb/report/html_report/)
