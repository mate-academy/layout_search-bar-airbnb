...
1. Replace `<your_account>` with your Github username in the links
    - [DEMO LINK](https://viktor-morhun.github.io/layout_search-bar-airbnb/)
    - [TEST REPORT LINK](https://viktor-morhun.github.io/layout_search-bar-airbnb/report/html_report/)
