...
- [DEMO LINK](https://dolnaro.github.io/layout_search-bar-airbnb/)
- [TEST REPORT LINK](https://dolnaro.github.io/layout_search-bar-airbnb/report/html_report/)
...
## The task
> Create HTML page with two search bars as designed in [the mockup](https://github.com/mate-academy/layout_search-bar-airbnb/blob/master/checklist.md). This search bar will be part of big project.
