...
1. Replace `<your-account>` with your Github username in the links
    - [DEMO LINK](https://velzepooz.github.io/layout_search-bar-airbnb/)
    - [TEST REPORT LINK](https://velzepooz.github.io/layout_search-bar-airbnb/report/html_report/)
