...
`SASS uded` please notice.

- [DEMO LINK](https://sviatoslv.github.io/layout_search-bar-airbnb/)
- [TEST REPORT LINK](https://sviatoslv.github.io/layout_search-bar-airbnb/report/html_report/)
