...
1. Replace `<your_account>` with your Github username in the links
    - [DEMO LINK](https://YuliiaChupryna.github.io/layout_search-bar-airbnb/)
    - [TEST REPORT LINK](https://YuliiaChuprina.github.io/layout_search-bar-airbnb/report/html_report/)
