...
- [DEMO LINK](https://<Ruslan-oss-max0>.github.io/layout_search-bar-airbnb/)
- [TEST REPORT LINK](https://<Ruslan-oss-max0>.github.io/layout_search-bar-airbnb/report/html_report/)
