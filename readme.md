...
- [DEMO LINK](https://github.com/OleksChernikov/layout_search-bar-airbnb.git)
- [TEST REPORT LINK](https://OleksChernikov.github.io/layout_search-bar-airbnb/report/html_report/)
