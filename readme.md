...
- [REPORT LINK](https://dsrtf0x-git.github.io/layout_search-bar-airbnb/report/html_report/)
  P.S. попробовал все вариации font-avenir, выбрал в котором только одну ошибку выдает.
