...
1. Replace `SobchukSasha` with your Github username in the links
    - [DEMO LINK](https://SobchukSasha.github.io/layout_search-bar-airbnb/)
    - [TEST REPORT LINK](https://SobchukSasha.github.io/layout_search-bar-airbnb/report/html_report/)
