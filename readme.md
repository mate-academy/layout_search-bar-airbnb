...
- [DEMO LINK](https://<alla-savaryn>.github.io/layout_search-bar-airbnb/)
- [TEST REPORT LINK](https://<alla-savaryn>.github.io/layout_search-bar-airbnb/report/html_report/)
