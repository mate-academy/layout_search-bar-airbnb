...
- [DEMO LINK](https://v-vytrykush.github.io/layout_search-bar-airbnb/)
- [TEST REPORT LINK](https://v-vytrykush.github.io/layout_search-bar-airbnb/report/html_report/)
