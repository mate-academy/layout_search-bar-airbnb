...
1. Replace `<your_account>` with your Github username in the links
    - [DEMO LINK](https://EvgeniiVoznyuk.github.io/layout_search-bar-airbnb/)
    - [TEST REPORT LINK](https://EvgeniiVoznyuk.github.io/layout_search-bar-airbnb/report/html_report/)
