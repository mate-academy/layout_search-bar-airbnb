...
- [DEMO LINK](https://Pavlo-lab-max-Kopalko.github.io/layout_search-bar-airbnb/)
- [TEST REPORT LINK](https://Pavlo-lab-max-Kopalko.github.io/layout_search-bar-airbnb/report/html_report/)
