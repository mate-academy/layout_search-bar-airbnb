...
1. Replace `antoniakstepan` with your Github username in the links
    - [DEMO LINK](https://antoniakstepan.github.io/layout_search-bar-airbnb/)
    - [TEST REPORT LINK](https://antoniakstepan.github.io/layout_search-bar-airbnb/report/html_report/)
