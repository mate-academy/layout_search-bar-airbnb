...
1. Replace `Oleg-Pushenko` with your Github username in the links
    - [DEMO LINK](https://Oleg-Pushenko.github.io/layout_search-bar-airbnb/)
    - [TEST REPORT LINK](https://Oleg-Pushenko.github.io/layout_search-bar-airbnb/report/html_report/)
