...
- [DEMO LINK](https://home2ego911.github.io/layout_search-bar-airbnb/)
- [TEST REPORT LINK](https://home2ego911.github.io/layout_search-bar-airbnb/report/html_report/)
...
- distance between two search bars must be 20px ❗️
- the big search bar must have top indent 20px
- follow styles from the mock ❗️
- default `font-weight` must be 300 ❗️
- a search bar has 3 state default, `hover` and `focus`
- don't use JavaScript ❗️
- use `@font-face` for fonts ❗️
- add attribute `data-qa="big"` for big search form, and `data-qa="small"` for small ❗️
